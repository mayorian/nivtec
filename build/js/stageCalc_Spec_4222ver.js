...
//Calc_SPECIFIC CHANGE for num of legs --------------------------------------------------------------------------------------------------------------------
                var result_vypocet =
                  4 + sirkaDec * 2 + dlzka_pocetZvys * 2 + sirkaDec * 2 * dlzka_pocetZvys;
//Calc_SPECIFIC CHANGE for num of legs --------------------------------------------------------------------------------------------------------------------
      ...
      function createCell(row, numOfLegs, pictureMode, index){
        ...
        var cellHeight = "140px";
            ...
            if(pictureMode == "fourLegs")
              ...
              {
                 button.setAttribute("style", "width:" + cellWidth + "; height:" + cellHeight + "; display: inline; color: white; background: url(imgs/twolegsLEFT.jpg) no-repeat; background-size: 100% 100%;"); 
                 button.innerHTML = " &nbsp &nbsp &nbsp⚫ <br>" + index + "<br>" + "R" + row + "  " + "LG" + numOfLegs + " <input type='checkbox' style='height:25px; width:25px;'>" +" <br> &nbsp &nbsp &nbsp⚫" ;
              }
            else if(pictureMode == "twoLegsDown")
              {
                 button.setAttribute("style", "width:" + cellWidth + "; height:" + cellHeight + "; display: inline; color: white; background: url(imgs/twolegsDOWN.jpg) no-repeat; background-size: 100% 100%;"); 
                 button.innerHTML = " &nbsp &nbsp &nbsp <br>" + index + "<br>" + "R" + row + "  " + "LG" + numOfLegs + " <input type='checkbox' style='height:25px; width:25px;'>" +" <br>⚫&nbsp &nbsp⚫" ;
              }
            else if(pictureMode == "oneLeg") // oneLeg is considered for two legs in vertical order 
              {
//Calc_SPECIFIC CHANGE for num of legs --------------------------------------------------------------------------------------------------------------------                 

                button.setAttribute("style", "width:" + cellWidth + "; height:" + cellHeight + "; display: inline; color: white; background: url(imgs/twolegsLEFT.jpg) no-repeat; background-size: 100% 100%;");  
                button.innerHTML = " &nbsp &nbsp &nbsp⚫ <br>" + index + "<br>" + "R" + row + "  " + "LG" + 2 + " <input type='checkbox' style='height:25px; width:25px;'>" +" <br> &nbsp &nbsp &nbsp⚫" ;
//Calc_SPECIFIC CHANGE for num of legs --------------------------------------------------------------------------------------------------------------------
              }
